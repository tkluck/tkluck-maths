using PolynomialRings; using MFDeformations; using MatrixFactorizations.Library; using OrbifoldEquivalence
using FlintNumbers

@ring! ℚ[a,b,c]
Q, f1,f2, g = MatrixFactorizations.Library.E14_Q10_matrix_and_equations()
W = MatrixFactorizations.Library.E14_Q10()
f = f1*f2
